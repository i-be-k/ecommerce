                            ...
                            >
                                ...
                                <div className="flex gap-8">
                                    ...
                                    <div className="flex flex-col justify-between">
                                        ...
                                        <p className="font-medium">{formatCurrency(Number((item.price * item.quantity).toFixed(2)))}</p>
                                    </div>
                                </div>
                                {/* DELETE BUTTON */}
                                <button onClick={() => removeFromCart(item)} title="Delete item" className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex items-center justify-center cursor-pointer">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between text-sm">
                            ...
                            <p className="font-medium">
                                {formatCurrency(Number(cart.reduce(
                        ...
                        <div className="flex justify-between text-sm">
                            ...
                            <p className="font-medium">{formatCurrency(1500.00)}</p>
                        </div>
                        <div className="flex justify-between text-sm">
                            <p className="text-gray-500">Shipping Fee</p>
                            <p className="font-medium">{formatCurrency(2000.00)}</p>
                        </div>
...
const CartPage = () => {
    return (
        <Suspense fallback={<div className="mt-12 text-center text-gray-500">Loading cart...</div>}>
            <CartContent />
        </Suspense>
    );
};
